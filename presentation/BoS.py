...
if __name__ == "__main__":
    ...
    print(f"[{actions[0]:<{max_len}} , {actions[0]:<{max_len}}]: (0, 0): {joint_action_count[0][0]}")
    print(f"[{actions[0]:<{max_len}} , {actions[1]:<{max_len}}]: (0, 1): {joint_action_count[0][1]}")
    print(f"[{actions[1]:<{max_len}} , {actions[0]:<{max_len}}]: (1, 0): {joint_action_count[1][0]}")
    print(f"[{actions[1]:<{max_len}} , {actions[1]:<{max_len}}]: (1, 1): {joint_action_count[1][1]}")
    print("=============================================================")
